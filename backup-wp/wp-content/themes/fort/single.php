...
<main class="site-main">
    <section class="single-section sec-spacing">
        <div class="container">
            <?php
            $sidebar_options = esc_attr($fort_theme_options['fort-sidebar-single-page']);
            global $post;
            $single_sidebar = get_post_meta($post->ID, 'fort_sidebar_layout', true);
            ...
            <div class="row <?php echo esc_attr($sidebar_class); ?>">
                <div id="primary" class="col-12 col-md-2-3 col-lg-2-3">
                    ...
                    while (have_posts()) :
                        ...
                        the_post_navigation(
                            array(
                                'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'fort') . '</span> <span class="nav-title">%title</span>',
                                'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'fort') . '</span> <span class="nav-title">%title</span>',
                            )
                        );
