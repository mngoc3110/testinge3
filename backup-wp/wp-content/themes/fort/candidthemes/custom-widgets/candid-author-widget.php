...
if (!class_exists('Fort_Author_Widget')) :
     ...
     * @since Fort 1.0.0
     */
    class Fort_Author_Widget extends WP_Widget
    {
        ...
        {
            $opts = array(
                'classname' => 'fort_widget_author',
                'description' => esc_html__('Display Author Profile.', 'fort'),
                'customize_selective_refresh' => true,
            );
            parent::__construct('fort-author', esc_html__('Fort Author', 'fort'), $opts);
        }
            ...
            <div class="fort-author-profile">
                ...
                <div class="profile-wrapper social-menu-wrap">
                    ...
                    <?php if ($author_facebook || $author_twitter || $author_linkedin || $author_instagram || $author_pinterest || $author_youtube || $author_vk) { ?>
                        <ul class="menu author-social-profiles fort-menu-social">
                            <?php if ($author_facebook) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_facebook); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('facebook', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_twitter) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_twitter); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('twitter', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_linkedin) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_linkedin); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('linkedin', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_instagram) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_instagram); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('instagram', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_pinterest) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_pinterest); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('pinterest', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_youtube) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_youtube); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('youtube', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_vk) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_vk); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('vk', 'fort'); ?></span></a>
                                </li>
                            <?php } ?>
        ...
        function form($instance)
        {
            ...
            // Defaults.
            $defaults = array(
                'title' => esc_html__('About Us', 'fort' ),
                'author_description' => '',
                'author_facebook' => '',
                'author_twitter' => '',
                'author_linkedin' => '',
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'fort'); ?></strong></label>
            ...
            <p>
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'fort') ?>"/>
            </p>

            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'fort'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_sign'); ?>">
                    <?php _e('Upload Author Signature Image', 'fort'); ?>
                </label>
                <br/>
                <?php
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_sign'); ?>"
                       value="<?php esc_attr_e('Upload Sign', 'fort') ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_facebook')); ?>">
                    <?php esc_html_e('Facebook:', 'fort'); ?>
                </label>
...
add_action('admin_enqueue_scripts', 'fort_widgets_backend_enqueue');
function fort_widgets_backend_enqueue()
{
    wp_register_script('fort-custom-widgets', get_template_directory_uri() . '/candidthemes/assets/custom/js/widget.js', array('jquery'), true);
    wp_enqueue_media();
    wp_enqueue_script('fort-custom-widgets');
}