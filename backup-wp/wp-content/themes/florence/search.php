		...
		<div id="content">
			...
			<div id="main" <?php if(get_theme_mod('solopine_archive_layout') == 'full' || get_theme_mod('solopine_archive_layout') == 'grid-full' || get_theme_mod('solopine_archive_layout') == 'list-full') : ?>class="fullwidth"<?php else : ?>class="regular"<?php endif; ?>>
				...
				<div class="archive-box">
					...
					<span><?php esc_html_e( 'Search results for', 'florence' ); ?></span>
					<h1><?php printf( esc_html__( '%s', 'florence' ), get_search_query() ); ?></h1>
				...
				<?php else : ?>
					...
					<p class="nothing"><?php esc_html_e( 'Không tìm thấy bài viết liên quan. Hãy thử tìm kiếm lại nhé!', 'florence' ); ?></p>
