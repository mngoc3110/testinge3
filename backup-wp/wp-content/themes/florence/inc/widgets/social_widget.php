...
class solopine_social_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'solopine_social_widget', 'description' => esc_html__('A widget that displays your social icons', 'florence') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'solopine_social_widget' );

		/* Create the widget. */
		parent::__construct( 'solopine_social_widget', esc_html__('Florence: Social Icons', 'florence'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<div class="widget-social">
				...
				<?php if($dribbble) : ?><a href="https://dribbble.com/<?php echo get_theme_mod('solopine_dribbble'); ?>" target="_blank"><i class="fa fa-dribbble"></i></a><?php endif; ?>
				<?php if($soundcloud) : ?><a href="https://soundcloud.com/<?php echo get_theme_mod('solopine_soundcloud'); ?>" target="_blank"><i class="fa fa-soundcloud"></i></a><?php endif; ?>
				<?php if($vimeo) : ?><a href="https://vimeo.com/<?php echo get_theme_mod('solopine_vimeo'); ?>" target="_blank"><i class="fa fa-vimeo-square"></i></a><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p><?php esc_html_e( 'Note: Set your social links in the Customizer', 'florence' ); ?></p>
		
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php esc_html_e( 'Show Facebook', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php esc_html_e( 'Show Twitter', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'instagram' )); ?>"><?php esc_html_e( 'Show Instagram', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php esc_html_e( 'Show Pinterest', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bloglovin' )); ?>"><?php esc_html_e( 'Show Bloglovin', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'googleplus' )); ?>"><?php esc_html_e( 'Show Google Plus', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'tumblr' )); ?>"><?php esc_html_e( 'Show Tumblr', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'youtube' )); ?>"><?php esc_html_e( 'Show Youtube', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'dribbble' )); ?>"><?php esc_html_e( 'Show Dribbble', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'soundcloud' )); ?>"><?php esc_html_e( 'Show Soundcloud', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'vimeo' )); ?>"><?php esc_html_e( 'Show Vimeo', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>"><?php esc_html_e( 'Show Linkedin', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'snapchat' )); ?>"><?php esc_html_e( 'Show Snapchat', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Show Email', 'florence' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'rss' )); ?>"><?php esc_html_e( 'Show RSS', 'florence' ); ?>:</label>
